...
public class UpdateUserProfileRequestValidator : IValidator<UpdateUserProfileRequest>
{
    public ValidationResult Validate(UpdateUserProfileRequest request)
    {
        ...
        {
            errors.Add("Current weight must be greater than zero.");
        }
