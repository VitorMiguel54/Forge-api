...
public class CreateBackofficeMuscleGroupRequestValidator : IValidator<CreateBackofficeMuscleGroupRequest>
{
    public ValidationResult Validate(CreateBackofficeMuscleGroupRequest request)
    {
